export function Footer() {
  return (
    <footer className="mt-auto border-t border-slate-50 bg-[#fdfdfd] py-12 text-[11px] text-slate-400 font-bold uppercase tracking-widest">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-between gap-8 px-4 sm:flex-row sm:px-6 lg:px-8">
        <p className="opacity-60">© {new Date().getFullYear()} YogaFlow AI. Mọi quyền được bảo lưu.</p>
