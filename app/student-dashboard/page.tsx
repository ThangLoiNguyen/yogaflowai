                  ...
                  <div className="relative z-10 grid md:grid-cols-2 gap-10">
                    <div className="space-y-8">
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-2 pt-2">
                          <Badge className="bg-white/10 text-black border-none text-[9px] font-black px-3 py-1 uppercase">{aiPlan.difficulty}</Badge>
                          <Badge className="bg-white/10 text-black border-none text-[9px] font-black px-3 py-1 uppercase">{aiPlan.focus_area}</Badge>
                        </div>
                      </div>
                      <div className="p-6 rounded-[2rem] bg-indigo-500/10 border border-white/5 backdrop-blur-3xl space-y-3">
                        ...
                        <p className="font-bold leading-relaxed text-black text-sm">"{aiPlan.weekly_plan}"</p>
                      </div>
                      <Link href="/classes">
                        <Button className="h-16 w-full md:w-auto px-10 text-black hover:bg-slate-50 hover:scale-[101%] font-black uppercase tracking-widest text-[11px] rounded-2xl shadow-2xl transition-all active:scale-95 group">
                    ...
                    <div className="hidden md:flex flex-col justify-between gap-4 border-l border-white/5 pl-12 py-2">
                      <div className="space-y-1">
                        ...
                        <p className="text-2xl font-black text-black">45 Phút <span className="text-xs text-slate-500">/ buổi</span></p>
                      </div>
                      <div className="space-y-1">
