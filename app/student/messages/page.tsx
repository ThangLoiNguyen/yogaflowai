      ...
      <div className="flex-1 flex flex-col min-w-0 bg-white">
        {activeChannel ? (
          <>
            {/* Header */}
            {/* Header */}
            <div className="h-16 border-b border-[var(--border)] flex items-center justify-between px-6 shrink-0 bg-white/80 backdrop-blur-sm sticky top-0 z-20">
              ...
              <div className="absolute inset-0 overflow-y-auto px-6 py-6 flex flex-col gap-2">
                {filteredMessages.length === 0 ? (
                  <div className="m-auto text-center opacity-50">
                    ...
                    <p className="text-sm text-[var(--text-hint)]">{msgSearch ? "Không tìm thấy tin nhắn." : "Hãy gửi lời chào đầu tiên!"}</p>
                  </div>
            ...
            <div className="border-t border-[var(--border)] bg-white px-6 py-5 shrink-0 shadow-[0_-4px_20px_-5px_rgba(0,0,0,0.05)]">
              ...
              <form onSubmit={sendMessage} className="flex items-center gap-2">
                ...
                <div className="relative">
                  ...
                  {showAttach && (
                    <div className="absolute bottom-11 left-0 bg-white border border-[var(--border)] shadow-xl rounded-2xl p-1.5 w-42 flex flex-col gap-0.5 z-50 animate-in slide-in-from-bottom-2">
