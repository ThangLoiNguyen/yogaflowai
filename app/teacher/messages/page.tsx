...
export default function TeacherMessagesPage() {
  ...
  return (
    <div className="flex fixed inset-0 lg:static h-[100dvh] lg:h-[calc(100vh-6rem)] bg-white lg:rounded-3xl border-none lg:border lg:border-slate-100 overflow-hidden lg:shadow-xl shadow-emerald-900/5 max-w-[1600px] mx-auto z-[40] lg:z-auto transition-all lg:mt-2">
