      ...
      <div className="space-y-4">
         <div className="grid lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-4 space-y-4">
               <div className="p-8 rounded-[2.5rem] bg-white border border-slate-100 shadow-sm space-y-6">
                  <div className="flex flex-col items-center text-center">
                     ...
                     <h3 className="txt-title text-slate-700 leading-tight mb-1 border-none tracking-tighter">{fullName}</h3>
                     <div className="px-5 py-1.5 rounded-full bg-emerald-50 text-emerald-700 txt-action mb-4">Certified Instructor</div>
                  ...
                  <div className="pt-8 border-t border-slate-50 grid grid-cols-2 gap-4">
                     <div className="p-3 rounded-2xl bg-slate-50 border border-slate-100 text-center">
                        <div className="txt-title leading-none pb-1 text-slate-700 border-none">142</div>
                        <div className="txt-action text-slate-300">Học viên</div>
                     </div>
                     <div className="p-3 rounded-2xl bg-amber-50 border border-amber-100 text-center">
                        <div className="txt-title leading-none pb-1 text-amber-600 border-none flex items-center justify-center gap-1">4.9 <Star className="w-3 h-3 fill-amber-500 border-none" /></div>
                        <div className="txt-action text-amber-300">Rating</div>
                     </div>
                     <div className="p-3 rounded-2xl bg-emerald-50 border border-emerald-100 text-center">
                        <div className="txt-title leading-none pb-1 text-emerald-600 border-none">{profile?.years_experience || 5} Năm</div>
                        <div className="txt-action text-emerald-300">Kinh nghiệm</div>
                     </div>
                     <div className="p-3 rounded-2xl bg-blue-50 border border-blue-100 text-center">
                        <div className="txt-title leading-none pb-1 text-blue-600 border-none">98%</div>
                        <div className="txt-action text-blue-300">Retention</div>
                     </div>
                  </div>
            ...
            <div className="lg:col-span-8 space-y-6">
               <h2 className="txt-title px-4 border-none mb-0 leading-tight">Thông tin chuyên môn</h2>
               ...
               <div className="p-6 bg-white border border-slate-100 rounded-[2.5rem] shadow-sm space-y-6">
                  <div className="flex items-start gap-4 p-5 bg-gradient-to-br from-emerald-50/50 to-white rounded-[2rem] border border-emerald-50 border-dashed">
                     ...
                     <div>
                        <h4 className="txt-action text-slate-700 mb-1 opacity-60">Tiểu sử</h4>
                        <p className="txt-content text-slate-500 leading-relaxed italic pr-4">
                           "{profile?.bio || "Chia sẻ yoga đam mê..."}"
                        </p>
                     </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                     <div className="space-y-4">
                        <div className="flex items-center gap-2 px-2">
                           ...
                           <h4 className="txt-action text-slate-600">Chuyên môn</h4>
                        </div>
                        <div className="flex flex-wrap gap-2">
                           {profile?.specialties?.map((spec: string) => (
                              <div key={spec} className="px-4 py-2 bg-white text-emerald-700 border border-emerald-50 rounded-2xl txt-action shadow-sm">
                                 {spec}
                              </div>
                           ))}
                        </div>
                     ...
                     <div className="space-y-4">
                        <div className="flex items-center gap-2 px-2">
                           ...
                           <h4 className="txt-action text-slate-600">Chứng chỉ</h4>
                        </div>
                        <div className="space-y-2">
                           {profile?.certifications?.map((cert: string) => (
                              <div key={cert} className="flex items-center gap-3 p-3 bg-slate-50/50 border border-slate-100 rounded-2xl">
                                 ...
                                 <span className="txt-action text-slate-600">{cert}</span>
                              </div>
                           ))}
                        </div>
                     </div>
